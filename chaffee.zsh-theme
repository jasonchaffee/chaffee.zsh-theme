...
if [[ "$TERM" != "dumb" ]] && [[ "$DISABLE_LS_COLORS" != "true" ]]; then
  ...
  PROMPT='%(?.%{$fg[green]%}⏎.%{$fg[red]%}⏎)%{$reset_color%} %{$fg[cyan]%}%c$(git_prompt_info) %(!.%{$fg_bold[red]%}#.%{$fg_bold[green]%}❯)%{$reset_color%} '
  ...
  PROMPT='%(?.%{$fg[green]%}⏎.%{$fg[red]%}⏎)%{$reset_color%} %c$(git_prompt_info) %(!.#.❯) '
